					...
					<div class="product-details"><!--product-details-->
						...
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								<img src="{{URL::to('eshoper/images/product-details/new.jpg')}}" class="newarrival" alt="" />
								<h2>{{$product_by_details->product_name}}</h2>
								<p>{{$product_by_details->product_color}}</p>
								<img src="{{URL::to('eshoper/images/product-details/rating.png')}}" alt="" />
								<span>
									...
									<input name="quentity" type="text" value="3" />
								...
								<a href=""><img src="{{URL::to('eshoper/images/product-details/share.png')}}" class="share img-responsive"  alt="" /></a>
							...
							<div class="tab-pane fade active in" id="reviews" >
								<div class="col-sm-12">
									...
									<form action="#">
										...
										<b>Rating: </b> <img src="{{URL::to('eshoper/images/product-details/rating.png')}}" alt="" />
