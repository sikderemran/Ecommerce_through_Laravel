...
<head>
    ...
    <link rel="apple-touch-icon-precomposed" sizes="144x144" href="{{URL::to('eshoper/images/ico/apple-touch-icon-144-precomposed.png')}}">
    <link rel="apple-touch-icon-precomposed" sizes="114x114" href="{{URL::to('eshoper/images/ico/apple-touch-icon-114-precomposed.png')}}">
    <link rel="apple-touch-icon-precomposed" sizes="72x72" href="{{URL::to('eshoper/images/ico/apple-touch-icon-72-precomposed.png')}}">
    <link rel="apple-touch-icon-precomposed" href="{{URL::to('eshoper/images/ico/apple-touch-icon-57-precomposed.png')}}">
</head><!--/head-->
<style type="text/css">
    .paymentWrap {
    padding: 50px;
...
<body>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="logo pull-left">
                            <a href="{{URL::to('/')}}"><img src="{{URL::to('eshoper/images/home/logo.png')}}" alt="" /></a>
                        </div>
                    ...
                    <div class="col-sm-8">
                        <div class="shop-menu pull-right">
                            <ul class="nav navbar-nav">
                                ...
                                <?php }else{ ?>
                                    <li><a href="{{URL::to('/login_check')}}"><i class="fa fa-crosshairs"></i> 
                                <?php } ?>
                    ...
                    <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                ...
                                <div class="col-sm-6">
                                    <img src="{{asset('eshoper/images/home/gir5l1.jpg')}}" class="girl img-responsive" alt="" />
                                    <img src="{{asset('eshoper/images/home/pricing.png')}}"  class="pricing" alt="" />
                                </div>
                            </div>
                            <?php 
                                $show_slider=DB::table('tbl_slider')
                                              ->where('publication_status',1)
                                              ->get();
                             ?>
                                @foreach($show_slider as $v_slider)
                            <div class="item">
                                <div class="col-sm-6">
                                    <h1><span>E</span>-SHOPPER</h1>
                                    <h2>Free E-Commerce Template</h2>
                        ...
                        <div class="brands_products"><!--brands_products-->
                            ...
                            <div class="brands-name">
                                <ul class="nav nav-pills nav-stacked">
                                    <?php 
                                        $all_brand=DB::table('manufacture')
                                                   ->where('publication_status','1')
                                                   ->get();

                                    ?>
                                    @foreach($all_brand as $v_brand)
                                    <li><a href="{{Url::to('/product_by_manufacture/'.$v_brand->manufacture_id)}}"> <span class="pull-right">(50)</span>{{$v_brand->manufacture_name}}</a></li>
                                    @endforeach
                                </ul>
                            </div>
                        </div><!--/brands_products-->
        ...
        <div class="footer-top">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-7">
                            ...
                            <div class="video-gallery text-center">
                                <a href="#">
                                    <div class="iframe-img">
                                        <img src="{{URL::to('eshoper/images/home/iframe1.png')}}" alt="" />
                                    </div>
                        ...
                        <div class="col-sm-3">
                            <div class="video-gallery text-center">
                                <a href="#">
                                    <div class="iframe-img">
                                        <img src="{{URL::to('eshoper/images/home/iframe2.png')}}" alt="" />
                                    </div>
                                    <div class="overlay-icon">
                                        <i class="fa fa-play-circle-o"></i>
                                    </div>
                        ...
                        <div class="col-sm-3">
                            <div class="video-gallery text-center">
                                <a href="#">
                                    <div class="iframe-img">
                                        <img src="{{URL::to('eshoper/images/home/iframe3.png')}}" alt="" />
                                    </div>
                                    <div class="overlay-icon">
                                        <i class="fa fa-play-circle-o"></i>
                                    </div>
                        ...
                        <div class="col-sm-3">
                            <div class="video-gallery text-center">
                                <a href="#">
                                    <div class="iframe-img">
                                        <img src="{{URL::to('eshoper/images/home/iframe4.png')}}" alt="" />
                                    </div>
                                    <div class="overlay-icon">
                                        <i class="fa fa-play-circle-o"></i>
                                    </div>
                    ...
                    <div class="col-sm-3">
                        <div class="address">
                            <img src="{{URL::to('eshoper/images/home/map.png')}}" alt="" />
    ...
    <script src="{{asset('eshoper/js/price-range.js')}}"></script>
